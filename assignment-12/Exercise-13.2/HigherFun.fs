...
let rec evalExpr (env : value env) (e : expr<typ>)
  ...
  | Prim1(ope,e1,_) ->
    evalExpr env e1 (fun v1 ->
                     ...
                     | ("print",TypP(_,_)) -> printf "%s " (ppValue v1); cont v1
  ...
  | Fst(e1,_) -> evalExpr env e1 (fun v1 -> match v1 with | PairV(a, _) -> cont (a)) econt
  | Snd(e1,_) -> evalExpr env e1 (fun v1 -> match v1 with | PairV(_, b) -> cont (b)) econt
