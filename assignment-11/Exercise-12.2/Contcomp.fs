...
let rec addCST i C =
    ...
    | (_, CSTI j :: SWAP :: LT :: NOT :: C1) -> addCST (System.Convert.ToInt32(i <= j)) C1        // <=
    | (_, CSTI j :: SWAP :: LT :: C1)        -> addCST (System.Convert.ToInt32(i > j)) C1         // >
    | (_, CSTI j :: EQ :: NOT :: C1)         -> addCST (System.Convert.ToInt32(i <> j)) C1        // !=
    | (_, CSTI j :: EQ :: C1)                -> addCST (System.Convert.ToInt32(not (i <> j))) C1  // ==
    | (_, CSTI j :: LT :: NOT :: C1)         -> addCST (System.Convert.ToInt32(i >= j)) C1        // >=
    | (_, CSTI j :: LT :: C1)                -> addCST (System.Convert.ToInt32(i < j)) C1         // <
    | _                     -> CSTI i :: C
